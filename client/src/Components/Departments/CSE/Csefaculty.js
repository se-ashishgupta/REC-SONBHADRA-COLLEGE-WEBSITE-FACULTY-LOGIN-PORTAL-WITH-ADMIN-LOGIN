...
const Csefaculty = () => {
  ...
  const getuserdatatowebsite = async () => {
    try {
      const resp = await axios.get("/getcsedatatowebsite");
      ...
      <div className="detail_card">
        ...
        <div className="col_2">
          ...
          <div className="info">
            ...
            <div className="info_text">{item.phone}</div>
          </div>
          <div className="info">
            <div className="info_logo">
              <div className="logo">
                ...
                item.qualifications.map((item, index) => {
                  return (
                    <>
                      <div className="qualification_item" key={index}>
                        <>
                          <span>{`${item.degree} ${item.university_college} ${item.specialization} ${item.year}`}</span>
                        </>
                      </div>
                    </>
                  );
          ...
          <div className="info">
            ...
            <div className="info_text">
              <a
                ...
                download={"http://localhost:8000/" + item.resume}
              >
